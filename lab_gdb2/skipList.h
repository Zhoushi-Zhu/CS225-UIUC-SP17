/**
 * @file skipList.h
 * Doubly Linked Skip List (lab_gdb2), skip list header file
 *
...
class SkipList
{
    public:
         ...
         */
        SkipList(int key, RGBAPixel value);
         ...
         */
        SkipList(int key, RGBAPixel value, int probability, int maxlevel);
         ...
         */
        void insert(int key, RGBAPixel value);
         ...
         */
        PNG makeImage(int imgSize, RGBAPixel fg, RGBAPixel bg);
         ...
         */
        PNG toPNG(int maxHeight = 100, RGBAPixel fg = RGBAPixel(0, 0, 0), RGBAPixel bg = RGBAPixel(255, 255, 255)) const;
...
//    private:
        ...
        /**
         * A helper function that draws the current list onto the specified PNG.
         *
         * @param png the PNG to draw onto
         * @param maxHeight the height of the PNG; scales heights into the range [0, maxHeight)
         * @param curr The current node we are considering
         * @param x The current x coordinate of the PNG we're drawing
         * @param fg The color to draw the nodes
         * @param bg The color of the background
         */
        void toPNG(PNG & png, int maxHeight, SkipNode * curr, size_t x, RGBAPixel fg, RGBAPixel bg) const;
